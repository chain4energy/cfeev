...
export interface MsgRemoveTransfer {
  creator: string;
  id: number;
}

export interface MsgRemoveTransferResponse {
}
...
function createBaseMsgRemoveTransfer(): MsgRemoveTransfer {
  return { creator: "", id: 0 };
}

export const MsgRemoveTransfer = {
  encode(message: MsgRemoveTransfer, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.id !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgRemoveTransfer {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgRemoveTransfer();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgRemoveTransfer {
    return {
      creator: isSet(object.creator) ? String(object.creator) : "",
      id: isSet(object.id) ? Number(object.id) : 0,
    };
  ...
  toJSON(message: MsgRemoveTransfer): unknown {
    const obj: any = {};
    message.creator !== undefined && (obj.creator = message.creator);
    message.id !== undefined && (obj.id = Math.round(message.id));
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<MsgRemoveTransfer>, I>>(object: I): MsgRemoveTransfer {
    const message = createBaseMsgRemoveTransfer();
    message.creator = object.creator ?? "";
    message.id = object.id ?? 0;
    return message;
...
function createBaseMsgRemoveTransferResponse(): MsgRemoveTransferResponse {
  return {};
}

export const MsgRemoveTransferResponse = {
  encode(_: MsgRemoveTransferResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgRemoveTransferResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgRemoveTransferResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromJSON(_: any): MsgRemoveTransferResponse {
    return {};
  },

  toJSON(_: MsgRemoveTransferResponse): unknown {
    const obj: any = {};
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<MsgRemoveTransferResponse>, I>>(_: I): MsgRemoveTransferResponse {
    const message = createBaseMsgRemoveTransferResponse();
    return message;
  },
};
...
export interface Msg {
  ...
  RemoveTransfer(request: MsgRemoveTransfer): Promise<MsgRemoveTransferResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  PublishEnergyTransferOffer(request: MsgPublishEnergyTransferOffer): Promise<MsgPublishEnergyTransferOfferResponse> {
    ...
    const promise = this.rpc.request("chain4energy.cfeev.cfeev.Msg", "PublishEnergyTransferOffer", data);
  ...
  StartEnergyTransferRequest(request: MsgStartEnergyTransferRequest): Promise<MsgStartEnergyTransferRequestResponse> {
    ...
    const promise = this.rpc.request("chain4energy.cfeev.cfeev.Msg", "StartEnergyTransferRequest", data);
  ...
  EnergyTransferStartedRequest(
    ...
    const promise = this.rpc.request("chain4energy.cfeev.cfeev.Msg", "EnergyTransferStartedRequest", data);
  ...
  EnergyTransferCompletedRequest(
    ...
    const promise = this.rpc.request("chain4energy.cfeev.cfeev.Msg", "EnergyTransferCompletedRequest", data);
  ...
  CancelEnergyTransferRequest(
    ...
    const promise = this.rpc.request("chain4energy.cfeev.cfeev.Msg", "CancelEnergyTransferRequest", data);
  ...
  RemoveEnergyOffer(request: MsgRemoveEnergyOffer): Promise<MsgRemoveEnergyOfferResponse> {
    ...
    const promise = this.rpc.request("chain4energy.cfeev.cfeev.Msg", "RemoveEnergyOffer", data);
    return promise.then((data) => MsgRemoveEnergyOfferResponse.decode(new _m0.Reader(data)));
  }

  RemoveTransfer(request: MsgRemoveTransfer): Promise<MsgRemoveTransferResponse> {
    const data = MsgRemoveTransfer.encode(request).finish();
    const promise = this.rpc.request("chain4energy.cfeev.cfeev.Msg", "RemoveTransfer", data);
    return promise.then((data) => MsgRemoveTransferResponse.decode(new _m0.Reader(data)));
  }
}
