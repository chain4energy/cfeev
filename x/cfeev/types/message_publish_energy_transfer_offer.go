...
func NewMsgPublishEnergyTransferOffer(creator string, chargerId string, tariff string, location *Location, name string, plugType PlugType) *MsgPublishEnergyTransferOffer {
